          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex flex-wrap justify-center md:justify-start gap-6 text-sm text-gray-400 mb-6 md:mb-0">
              <a className="group relative hover:text-white transition-colors duration-300">
                ...
                <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-3 w-72 bg-gray-800 border border-gray-700 rounded-xl p-4 text-xs text-gray-300 leading-relaxed opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 shadow-xl z-50 pointer-events-none">
                  <p className="font-semibold text-white mb-2">Privacy Policy</p>
                  <p>Your privacy matters to us. We collect and use your personal information only to provide and improve our services. We never sell your data to third parties. For full details, review our complete Privacy Policy.</p>
              ...
              <a className="group relative hover:text-white transition-colors duration-300">
                ...
                <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-3 w-72 bg-gray-800 border border-gray-700 rounded-xl p-4 text-xs text-gray-300 leading-relaxed opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 shadow-xl z-50 pointer-events-none">
                  ...
                  <p>By using JobPortal, you agree to our Terms of Service. Users must provide accurate information and use the platform responsibly. We connect job seekers with employers in good faith. Please review our full terms for complete details.</p>
                  <div className="absolute top-full left-1/2 -translate-x-1/2 border-4 border-transparent border-t-gray-700"></div>
                </div>
              </a>
              <a className="group relative hover:text-white transition-colors duration-300">
                ...
                <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-3 w-72 bg-gray-800 border border-gray-700 rounded-xl p-4 text-xs text-gray-300 leading-relaxed opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 shadow-xl z-50 pointer-events-none">
                  ...
                  <p>We use cookies to improve your browsing experience, analyze site traffic, and personalize content. By continuing to use our site, you consent to our use of cookies in accordance with this policy.</p>
                  <div className="absolute top-full left-1/2 -translate-x-1/2 border-4 border-transparent border-t-gray-700"></div>
                </div>
              </a>
              <Link
